...
from .utils import kaiming_normal_init, constant_init, normal_init
...
class MobileNetV2(nn.Layer):
    def __init__(
        ...
        Args:
            ...
            block: Layer specifying inverted residual building block for mobilenet
            norm_layer: Layer specifying the normalization layer to use
        """
        ...
        features: List[nn.Layer] = [ConvBNReLU(3, input_channel, stride=2, norm_layer=norm_layer)]
